class DecimalSystem:
	...
	def validar(numero: str) -> bool:
		"""Verifica que la cadena represente un número decimal válido (solo dígitos y un punto opcional)."""
	...
	def from_decimal(valor_decimal: float, precision: int = 12) -> str:
		"""Devuelve la representación decimal como cadena, recortando ceros innecesarios."""
